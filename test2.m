% test2.m
% fixing the energy norm for the computation

%I think you can also just use the Chebyshev differentiation matrix when
%computing the elocity gradient

%I also don't think there's any reason to be working with dimensional
%variables. I think I can simply be working with dimensionaless quantities

%I also still need to compare my Chebhyshev differentiation matrix because
%they seem to be incorrect for this
%% 1.Compute the velocity profile of Re_tau = 1000
...
semilogx(yplot,dudns,'-')
hold on
% semilogy(yplot,dudns2,'-')
hold off
legend()
...
kx = 2*pi/1100*Re_tau; %input alpha value
kz = 2*pi/110*Re_tau; %input for beta value
